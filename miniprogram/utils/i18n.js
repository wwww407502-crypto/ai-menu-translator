...
const SYSTEM_COPY = {
  'zh-CN': {
    ...
    takePhoto: '拍照识别',
    importAlbum: '相册导入',
    importMultiAlbum: '导入多页菜单',
    multiSelectTitle: '已选择 {count} 页菜单',
    startMultiUpload: '开始识别全部',
    removeFile: '移除',
    uploadingProgress: '正在识别第 {current} 页 / 共 {total} 页',
    multiModeHint: '支持识别餐厅的正反面或多页菜单',
    notice: '提示',
    ...
    uploadError: '图片上传失败',
    parseTimeout: '菜单解析超时，请换一张更清晰的照片再试。',
    providerError: '后端 AI 服务未配置，请检查 API Key。',
    identifyMenu: '识别菜单',
    exchangeRate: '汇率',
    retry: '重新识别',
  ...
  'zh-TW': {
    ...
    takePhoto: '拍照辨識',
    importAlbum: '相簿匯入',
    importMultiAlbum: '匯入多頁菜單',
    multiSelectTitle: '已選擇 {count} 頁菜單',
    startMultiUpload: '開始識別全部',
    removeFile: '移除',
    uploadingProgress: '正在識別第 {current} 頁 / 共 {total} 頁',
    multiModeHint: '支援識別餐廳的正反面或多頁菜單',
    notice: '提示',
    ...
    uploadError: '圖片上傳失敗',
    parseTimeout: '菜單解析逾時，請換一張更清晰的照片再試。',
    providerError: '後端 AI 服務未設定，請檢查 API Key。',
    identifyMenu: '辨識菜單',
    exchangeRate: '匯率',
    retry: '重新辨識',
  ...
  ja: {
    ...
    importMultiAlbum: '複数ページメニュー',
    multiSelectTitle: '{count} ページ選択中',
    startMultiUpload: '全て認識開始',
    removeFile: '削除',
    uploadingProgress: '{current} / {total} ページ目を認識中',
    multiModeHint: '両面・複数ページのメニューに対応',
    notice: 'お知らせ',
    ...
    parseTimeout: 'メニュー解析がタイムアウトしました。より鮮明な写真でもう一度お試しください。',
    providerError: 'バックエンドの AI サービスが設定されていません。API Key を確認してください。',
    identifyMenu: 'メニュー解析',
    exchangeRate: '為替',
    retry: '再解析',
  ...
  ko: {
    ...
    importMultiAlbum: '여러 페이지 메뉴',
    multiSelectTitle: '{count} 페이지 선택됨',
    startMultiUpload: '전체 인식 시작',
    removeFile: '제거',
    uploadingProgress: '{current} / {total} 페이지 인식 중',
    multiModeHint: '양면 및 여러 페이지 메뉴 지원',
    notice: '안내',
    ...
    parseTimeout: '메뉴 분석 시간이 초과되었습니다. 더 선명한 사진으로 다시 시도해 주세요.',
    providerError: '백엔드 AI 서비스가 설정되지 않았습니다. API Key를 확인해 주세요.',
    identifyMenu: '메뉴 인식',
    exchangeRate: '환율',
    retry: '다시 인식',
  ...
  en: {
    ...
    importMultiAlbum: 'Import Multi-Page Menu',
    multiSelectTitle: '{count} Pages Selected',
    startMultiUpload: 'Scan All Pages',
    removeFile: 'Remove',
    uploadingProgress: 'Scanning page {current} of {total}',
    multiModeHint: 'Supports front/back or multi-page menus',
    notice: 'Notice',
    ...
    parseTimeout: 'Menu parsing timed out. Please try again with a clearer photo.',
    providerError: 'Backend AI provider is not configured. Please check the API key.',
